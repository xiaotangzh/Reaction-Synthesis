...
public class OpponentSeries : ComponentSeries {
    ...
    public OpponentSeries(TimeSeries global, Actor actor, RootSeries actorRoot, Actor rival, RootSeries rivalRoot) : base(global) {
        Actor = actor;
        ActorRoot = actorRoot;
        Rival = rival;
        RivalRoot = rivalRoot;
