...
public static class UltiDraw {
	...
	public static void DrawLine(Vector3 start, Vector3 end, float thickness, Color startColor, Color endColor) {
		if(ReturnDraw()) {return;};
		DrawLine(start, end, thickness, thickness, startColor, endColor);
	}

	public static void DrawLine(Vector3 start, Vector3 end, float startThickness, float endThickness, Color startColor, Color endColor) {
		if(ReturnDraw()) {return;};
		DrawLine(start, end, ViewPosition - (start+end)/2f, startThickness, endThickness, startColor, endColor);
    }

	public static void DrawLine(Vector3 start, Vector3 end, Vector3 normal, float startThickness, float endThickness, Color startColor, Color endColor) {
		if(ReturnDraw()) {return;};
